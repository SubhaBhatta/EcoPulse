...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    // { icon: Map, label: 'Pollution Map', path: '/map' },
   
    // { icon: BarChart3, label: 'Analytics', path: '/analytics' },
    // { icon: Trophy, label: 'Eco Challenges', path: '/challenges' },
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 glass border-r border-white/10 p-6 flex flex-col hidden lg:flex z-50">
      <div className="flex items-center gap-3 mb-10 px-2">
        ...
        <h1 className="text-xl font-bold tracking-tight">EcoPulse <span className="text-primary italic">KTM</span></h1>
      </div>
